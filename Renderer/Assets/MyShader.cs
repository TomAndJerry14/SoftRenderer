...
namespace SoftRenderer
{
    internal class MyShader : IShader
    {
        ...
        public Vector4 vertex(int faceIndex, int vertexIndex)
        {
            ...
            varying_normal.SetColumn(vertexIndex, /*(cam.Projection * cam.ModelView).inverse.transpose * */ new Vector4(normal.x, normal.y, normal.z, 1));
        ...
        public bool fragment(Vector3 bar, out Color color, Texture2D output)
        {
            ...
            var ind = Vector3.Dot(bn, -SoftRenderer.light.dir) * 0.5f;
            ind += 0.5f;
            color.r *= ind;
            color.g *= ind;
            color.b *= ind;
